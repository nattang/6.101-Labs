...
def test_inverted_2():
    result = lab.inverted({'height': 1, 'width': 4, 'pixels': [25, 77, 159, 210]})
    expected = {'height': 1, 'width': 4, 'pixels': [230, 178, 96, 45]}
    compare_images(result, expected)
...
def test_blurred_black_image():
    ...
    result = lab.blurred({'height': 6, 'width': 5, 'pixels': [
    255, 255, 255, 255, 255, 
    255, 255, 255, 255, 255, 
    255, 255, 255, 255, 255, 
    255, 255, 255, 255, 255, 
    ...
    expected = {'height': 6, 'width': 5, 'pixels': [
    255, 255, 255, 255, 255, 
    255, 255, 255, 255, 255, 
    255, 255, 255, 255, 255, 
    255, 255, 255, 255, 255, 
